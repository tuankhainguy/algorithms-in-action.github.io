...
const allalgs = {
  ...
  'Hashing': {
    ...
    category: 'Hashing',
    param: <Param.HASHParam/>,
    instructions: Instructions.HASHInstruction,
    explanation: Explanation.HASHExp,
    extraInfo: ExtraInfo.HASHInfo,
    pseudocode: {
      find: Pseudocode.hash_lp,
    },
    controller: {
      find: Controller.hash_lp,
    },
  },
  'dijkstra': {
